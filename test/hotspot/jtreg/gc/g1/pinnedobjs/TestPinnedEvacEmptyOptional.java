 ...
 * @run main/othervm -XX:+UnlockDiagnosticVMOptions -XX:+WhiteBoxAPI -XX:+UseG1GC -XX:+G1RetainedRegionsAreOptional
 *      -Xbootclasspath/a:. -Xlog:gc=debug,gc+ergo+cset=trace,gc+phases=debug -XX:G1HeapRegionSize=1m -Xms30m  gc.g1.pinnedobjs.TestPinnedEvacEmptyOptional
 */
...
public class TestPinnedEvacEmptyOptional {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Do garbage collection to move the pinned object into old generation.
        wb.youngGC();

        // And forget the (Java) reference to the int array. After this, the garbage
        // collection should find a completely empty pinned region during optional
        // collection. The collector must not collect/free it.
        o = null;

        // Do garbage collection to zap all data in the pinned region.
        wb.youngGC();
    }
}
