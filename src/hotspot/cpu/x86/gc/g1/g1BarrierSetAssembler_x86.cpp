...
void G1BarrierSetAssembler::g1_write_barrier_post(MacroAssembler* masm,
                                                  ...
                                                  Register tmp2) {
  Label done;
  generate_post_barrier_fast_path(masm, store_addr, new_val, thread, tmp, tmp2, done, G1UseConcRefinement ? gen_all_barrier_parts() : gen_no_barrier_parts());
  __ bind(done);
}
...
void G1BarrierSetAssembler::g1_write_barrier_post_c1(MacroAssembler* masm,
                                                     ...
                                                     Register tmp2) {
  Label done;
  generate_post_barrier_fast_path(masm, store_addr, new_val, thread, tmp1, tmp2, done, G1UseConcRefinement ? gen_all_barrier_parts() : gen_no_barrier_parts());
  __ bind(done);
}
