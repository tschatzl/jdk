...
#define TP_REMSET_INVESTIGATION_RELEVANT /* Just a marker for relevant changes */
#define TP_REMSET_INVESTIGATION_DYNAMIC_SWITCH_PLACEHOLDER (G1CollectedHeap::heap()->is_throughput_barrier_enabled())
#define TP_REMSET_INVESTIGATION_ONLY_IF_OTHERWISE_ENABLE(condition) TP_REMSET_INVESTIGATION_ONLY(if (condition))
#define TP_REMSET_INVESTIGATION_ONLY_IF_OTHERWISE_DISABLE(condition) TP_REMSET_INVESTIGATION_ONLY(if (condition)) NOT_TP_REMSET_INVESTIGATION(if (false))
#define TP_REMSET_INVESTIGATION_ONLY_ELSE_OTHERWISE_ENABLE TP_REMSET_INVESTIGATION_ONLY(else)
#define TP_REMSET_INVESTIGATION_ONLY_ELSE_OTHERWISE_DISABLE TP_REMSET_INVESTIGATION_ONLY(else) NOT_TP_REMSET_INVESTIGATION(if (false))
